...
class CompanyTesting < MiniTest::Test
    ...
    def test_get_employee_salary
      emp_one = peter()
      assert_equal 10000, emp_one.salary
    end
    def test_sum_salary
        emp_one = jason()
        emp_two = peter()
        ...
        assert_equal 60000, dept.sum_salary
    end
    def test_add_review
      emp_one = jason()
    ...
    def test_employee_performance
      ...
      assert_equal "Great job, you deserve a raise!", performance
    end
    def test_give_employee_raise
      emp_one = jason()
      emp_one.give_raise(0.10)
      assert_equal 55000, emp_one.salary
    end
end
